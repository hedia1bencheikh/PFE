...
$projet=DB::table('projet')->join('gouvernorat','gouvernorat.id','=','projet.id_gouvernorat')->select('projet.*')->where('projet.id_gouvernorat',$id)->get();
...
echo $projet;
    ...
    $data=DB::table('quartier')->join('limite_quartier','limite_quartier.id_quartier','=','quartier.id')->join('projet','projet.id','=','quartier.id_projet')->join('gouvernorat','gouvernorat.id','=','projet.id_gouvernorat')->select('quartier.*','projet.rang_projet','projet.nombre_quartier','projet.nombre_maison','projet.superficie_quartier','projet.image1','projet.image2','projet.image3','limite_quartier.*')->where('projet.id','=',$req->id)->get();
    return response()->json($data);
  echo $data;
...
$projets=DB::table('projet')->where('id','like','%'.$search.'%')->paginate(5);
return view('backend/projet/show',compact('projets'));
